...
export default class PatientPaymentScreen extends BaseClass {
    ...
    _renderHeader = () => {
        ...
        return (
            <Header
                ...
                leftComponent={(
                    <TouchableOpacity activeOpacity={1} delayPressIn={0}  style={{padding: 12}} onPress={() => navigation.openDrawer()}>
    ...
    render() {
        const { navigation } = this.props;
        const { cardsList, registrationCharges, monthlyCharges } = this.state;
                ...
                <MainContainer>
                    ...
                    <ShadowViewContainer style={{ borderRadius: wp("8%") }}>
                        <DetailAreaContainer >
                            ...
                            <SimpleRow >
                                <RegularText>{STRINGS.MONTHLY_CHARGES_TEXT}</RegularText>
                                <RegularBlueText>${monthlyCharges}</RegularBlueText>
                            </SimpleRow>
