...
import { GetPharmacyHistoryApi } from '../../../../../redux/actions/GetHistoryAction'
import Moment from 'moment';
import propTypes from 'prop-types';
let checkVar = false;

class PharmacyHistory extends BaseClass {
    ...
    componentDidUpdate(prevProps, preState, snapShot) {
        ...
        } else if (this.props.routeKey === 1 || this.props.routeKey === 0) {
            checkVar = true;
        }
    }
    ...
    _renderItem = (item, index) => {
        return (
            <TouchableOpacity onPress={() => this.props.navigation.navigate("PharmacyDetails",
                {
                    id: item.pharmacy_id,
                ...
                <ListItemContainer>
                    ...
                    <Spacer row={2} />
                    <CenterContainer>
                        <NameText>{item.pharmacy_data.name}</NameText>
                        <Spacer space={1} />
                        <AgeText>{item.pharmacy_data.address}</AgeText>
                        <Spacer space={1} />
            ...
            <MainContainer style={{ backgroundColor: COLORS.WHITE_COLOR }}>
                ...
                {(historyList.length !== 0)
                    ...
                    <FlatList
                        ...
                        data={this.filterList(historyList.pharmacy_requests)}
                        renderItem={({ item, index }) => this._renderItem(item, index)}
                    />
                    :
                    <NoDataFoundComponent title={"No Pharmacy History available!"} />
                }
            </MainContainer>
        )
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(PharmacyHistory);
