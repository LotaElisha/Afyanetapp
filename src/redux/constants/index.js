...
//temporary api
// module.exports.BASE_URL = "http://dev.afyanetwork.com/api/v2/";
...
export const API = {
  ...
  GET_GENERAL_DOCTOR_API:
    "general-doctor-search?doctor_type=General Physician&doctor_name=",
  GET_DOCTOR_STATUS_API: "doctor-status?id=",
  CHANGE_DOCTOR_STATUS_API: "change-status",
  GET_DOCTOR_SPECIALIZATION_SEARCH_LIST_API:
    "specialized-doctor-search?specialization=",
  ACTIVE_PATIENT_CONSULTATION_API: "patient-active-consultations?caretaker_id=",
  PREVOIUS_PATIENT_CONSULTATION_API:
    "patient-previous-consultations?caretaker_id=",
  ...
  GET_CONSULTATION_REQUEST_DETAILS_API:
    "patient-consultation-detail?request_id=",
  ...
  DOCTOR_COMPLETED_HISTORY_CONSULTATION:
    "doctor-completed-history-consultations?doctor_id=",
  ...
  PATIENT_PHARMACY_HISTORY_LIST_API:
    "pharmacy-request-history-list?caretaker_id=",
  ...
  DR_CONSULTATION_HISTORY_BY_STATUS:
    "doctor-consultation-history-by-status?doctor_id=",
  ...
  GET_ACTIVE_CONSULTATION_DETAIL:
    "active-consultations-detail?consultation_id=",
};
