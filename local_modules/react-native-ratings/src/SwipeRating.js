...
const TYPES = {
  star: {
    source: STAR_IMAGE,
    color: COLORS.ACTIVE_RATING_COLOR,
    backgroundColor: COLORS.INACTIVE_RATING_COLOR
  },
  heart: {
    source: HEART_IMAGE,
    color: '#e74c3c',
...
export default class SwipeRating extends Component {
  static defaultProps = {
    ...
    ratingColor: COLORS.ACTIVE_RATING_COLOR,
    ratingBackgroundColor: COLORS.INACTIVE_RATING_COLOR,
    ratingCount: 5,
    imageSize: 40,
